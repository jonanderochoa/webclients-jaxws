 ...
 * 
 */
@WebServiceClient(name = "peliculasservice", targetNamespace = "http://pelicula.ws.formacion.ipartek.com/", wsdlLocation = "http://localhost:8080/webservices-jaxws/peliculaws?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/webservices-jaxws/peliculaws?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/webservices-jaxws/peliculaws?wsdl', retrying as a local file");
